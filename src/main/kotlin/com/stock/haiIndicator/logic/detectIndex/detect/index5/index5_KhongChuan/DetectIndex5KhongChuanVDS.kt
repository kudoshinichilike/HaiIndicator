 ...
 *
 */
object DetectIndex5KhongChuanVDS: IDetectIndex {
...
//        val con2 = data.openedPrice >= data.closedPrice
        val con3 = data.closedPrice > data.lowPrice
        val con4 = (data.lowPrice / data.refPrice) < TEST_LOWEST_PRICE_THREAD
    ...
    private fun calcCntHappenLowestPrice(data: OneDayVDS): Int {
        ...
        while (firstMatchIdx != -1) {
            ...
            while (lastSublistIdx < listMatch.size && listMatch[lastSublistIdx].matchedPrice == data.lowPrice)  {
            ...
            if (lastSublistIdx == listMatch.size)
                ...
                firstMatchIdx = listMatch.indexOfFirst { it.matchedPrice == data.lowPrice }
            }
        }
