...
//        listCodeSearch: [],
        ...
        multiply: 2,
        listMultiply: [2, 3, 5, 10, 20],

        numDateBf: 10,
        listNumDateBf: [5, 7, 10, 20, 30],
    ...
    methods: {
        onSearchClicked() {
            ...
            if (isEmpty(this.code)) this.makeToast('danger', 'Bạn chưa nhập đủ thông tin')
                ...
                axios
                    .post('api/haiIndicator/nen8', {
                        code: listCodeReq,
                        dateStart: this.startDate,
                        dateEnd: this.endDate,
                        multiply: this.multiply,
                        numDateBf: this.numDateBf
                    })
                    .then(res => {
                        if (res.data.error != 0)
...
//                console.log(e)
    ...
    watch: {
        startDate: function (val) {
            ...
            endDateCalc.setDate(endDateCalc.getDate() + 8);
        ...
        endDate: function (val) {
            ...
            startDateCalc.setDate(startDateCalc.getDate() - 8);
