var games = [
    {value: 'match3Dev', text: 'match3Dev'},
    {value: 'match3QC', text: 'match3QC'},
    {value: 'match3Playtest', text: 'match3Playtest'}
];

var userDataGameToClassNames = {
    'match3Dev': ['model.AccountInfo', 'model.ExtraInfo', 'model.PaymentModel'],
    'match3QC': ['model.AccountInfo', 'model.ExtraInfo', 'model.PaymentModel'],
    'match3Playtest': ['model.AccountInfo', 'model.ExtraInfo', 'model.PaymentModel']
}
...
var viewAdmin = new Vue({
    ...
    methods: {
        ...
        makeToastResult(data) {
            console.log("makeToastResult data= ", data);
        ...
        userData_onGetDetailedInfo() {
            ...
            axios
                ...
                .then(res => {
                    ...
                    if (res.data.error === 0)
                        this.valueDataMatch3 = res.data.string;
                    this.makeToastResult(res.data);
                })
                .catch(e => this.makeToastException(e))
                .finally(() => this.isProcessing = false);
    ...
    computed: {
        ...
        userData_onSet_disabled() {
            return !this.userData_selected || !this.userData_userId || !this.userData_className || !this.valueDataMatch3 || !this.checkedSetData;
        },
        //
